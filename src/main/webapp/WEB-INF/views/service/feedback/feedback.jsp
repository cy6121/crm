			...
			<div class="modal-body">
				<form id="dealForm" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea rows="3" class="form-control" name="deal" id="deal" readonly="readonly"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">处理结果</label>
						<div class="col-sm-9">
							<textarea rows="3" class="form-control" name="result" id="result"></textarea>
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	$("#dealBtn").click(function() {
		...
		var args = {"svr_id":$("#svr_id").val(),"satisfy":$("#satisfy").val(),"result":$("#result").val()};
		
		$.post("${ctx}/service/feedback/deal", args).done(function(result) {
			if (result == "success") {
				$("#dealModal").modal("hide");
