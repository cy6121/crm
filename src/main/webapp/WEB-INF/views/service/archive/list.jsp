	...
	$(function() {
		dataTable = $("#dataTable").DataTable({
			...
			"columns" : [ //返回的JSON中的对象和列的对应关系
					...
					{"data" : "allot.name"},
					{"data" : function(row) {
						return "<div class='pull-left action-buttons'><a href='${ctx}/service/archive/"+row.svr_id+"' style='text-decoration: none;' class='blue'><i class='icon-zoom-in bigger-110'></i></a> </div>";
					}}],
			"language" : {
