...
//省市级联动
$.jChinaArea = $.fn.jChinaArea = function (o) {
	o = $.extend({
		s1: null,
		s2: null,
		s3: null
	...
	area.fillOption(sProvince, '0', o.s1);
	area.fillOption(sCity, '0,' + sProvince.val(), o.s2);
	area.fillOption(sCounty, '0,' + sProvince.val() + ',' + sCity.val(), o.s3);


	sProvince.change(function () {
		sCity.empty();
		area.fillOption(sCity, '0,' + sProvince.val());
		sCounty.empty();
		area.fillOption(sCounty, '0,' + sProvince.val() + ',' + sCity.val());
